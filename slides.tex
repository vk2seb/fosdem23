...
\begin{frame}{}
    \begin{center}
        \includegraphics[height=3.5cm]{img_tiliqua/tiliqua-front-left.jpg}
    \end{center}
...
\begin{frame}{}
    \begin{center}
        \includegraphics[height=8.4cm]{img_tiliqua/soldiercrab-top.jpg}
    \end{center}
\end{frame}

% emphasis: model is distinct components and streams
\begin{frame}{MyDspComponent picture}
\end{frame}

\begin{frame}[fragile]

    \begin{minted}[]{python}
class MyDspComponent(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        rs  = dsp.Resample(fs_in=48000*N_UP, m_down=4)
        # Connect them together ...
        wiring.connect(m, flipped(self.i), nco.i)
        wiring.connect(m, nco.o, ws.i)
        wiring.connect(m, ws.o, rs.i)
        wiring.connect(m, rs.o, flipped(self.o))
...
\begin{frame}{Demo}
    \begin{block}{\texttt{tiliqua} example bitstreams --}
        \begin{itemize}
